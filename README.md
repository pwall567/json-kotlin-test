...
[![Build Status](https://travis-ci.org/pwall567/json-kotlin-test.svg?branch=master)](https://travis-ci.org/pwall567/json-kotlin-test)
...
### Gradle
```groovy
    testImplementation 'net.pwall.json:json-kotlin-test:0.11'
```
### Gradle (kts)
```kotlin
    testImplementation("net.pwall.json:json-kotlin-test:0.11")
